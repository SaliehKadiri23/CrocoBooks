...
const AddNewBook = () => {
  ...
  return (
    <Modal
      transparent={true}
      className="mx-3 flex-1 h-[100%] justify-center items-center bg-transparent"
    >
      <View className="w-full h-[100%] justify-center items-center bg-transparent ">
        <View className="bg-gray-100 flex flex-col max-h-[90%] items-center border-2 border-gray-300 w-[93%] rounded-xl mx-auto ">
          <Text className="text-3xl text-center text-gray-800 border-b-2 border-b-blue-400 font-bold mt-10 mb-3">
            Add A New Book
          </Text>
          {/* Form Wrapper */}
          <ScrollView className="w-full ">
            ...
            <View className="w-full mt-4">
              <TouchableOpacity
                ...
                className="mx-auto w-[70%] rounded-2xl flex bg-green-500"
              >
            ...
            <View className="w-full mt-7">
              <TouchableOpacity
                ...
                className="w-full pl-5 flex flex-row items-center mb-5"
              >
                <AntDesign name="arrowleft" size={30} color="red" />
                <Text className="text-xl text-red-600 font-bold ml-3">
                  Close
                </Text>
              </TouchableOpacity>
            </View>
